...
function Update()
    ...
    if(spawntimer % 120 == 10) then
        ...
        for i=1,orba+1 do
            ...
            spella.SetVar('peluncuran', math.pi * 3 * i / orba)
    ...
    elseif(spawntimer % 120 == 40) then
        ...
        for i=1,orbb+1 do
            ...
            spellb.SetVar('peluncurans', math.pi * 3 * i / orbb)
    ...
    elseif(spawntimer % 120 == 80) then
        ...
        for i=1,orbc+1 do
            ...
            spellc.SetVar('peluncuranss', math.pi * 3 * i / orbc)
    ...
    for i=1,#spells do
        ...
        local posxa = (120*rotasi)*math.cos(waktu + peluncuran)
        local posya = (120*rotasi)*math.sin(waktu + peluncuran) + y
    ...
    for i=1,#spellsb do
        ...
        local posxc = (120*rotasiss)*math.sin(waktuss + peluncuranss)
        local posyc = (120*rotasiss)*math.cos(waktuss + peluncuranss) + y
        spellc.MoveTo(posxc, posyc)
        rotasiss = rotasiss + 1 / 90
